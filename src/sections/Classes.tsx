...
const CLASS_FORMATS = [
  ...
  },
  {
    ...
    accent: 'border-dark-green/40 hover:border-dark-green',
    bg: 'bg-dark-green/5',
  },
  {
    key: 'project',
    ...
    accent: 'border-burgundy/40 hover:border-burgundy',
    bg: 'bg-burgundy/5',
  },
  {
    key: 'join',
    ...
    accent: 'border-deep-blue/30 hover:border-deep-blue',
    bg: 'bg-deep-blue/5',
  },
]
        ...
        {CLASS_FORMATS.map(({ key, icon, accent, bg }, i) => (
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-2">
              <span className="rounded-full bg-white/10 px-3 py-1 font-ui text-xs text-cream/60">
                {t(`classes.${key}.for`)}
              </span>
            </div>
            <p className="mt-3 font-ui text-sm font-semibold text-gold">
              {t(`classes.${key}.price`)}
            </p>
            <a
              ...
              className="mt-4 inline-block rounded-full bg-gold/20 px-5 py-2 font-ui text-sm font-medium text-gold transition-colors hover:bg-gold/30"
            >
              {t('classes.cta')}
            </a>
          </motion.div>
